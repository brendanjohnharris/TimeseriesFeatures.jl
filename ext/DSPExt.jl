...
Analytic_Amplitude = Feature(x -> x |> hilbert .|> abs, :Analytic_Amplitude, ["transform", "amplitude"], "Analytic amplitude of the time series, from the Hilbert Transform")
...
PPC = PairwiseFeature(pairwisephaseconsistency, :PPC, ["synchrony", "phase"], "The pairwise-phase consistency, an unbiased estimate of the phase-locking value") # Assumes phase time series
...
PLV = PairwiseFeature(phaselockingvalue, :PLV, ["synchrony", "phase"], "The phase-locking value") # Assumes phase time series
